...
const STATIC_ROUTES = [
  ...
  { path: "/solutions/cooperatives", priority: "0.9", changefreq: "monthly" },
  { path: "/solutions/large-miners", priority: "0.9", changefreq: "monthly" },
  { path: "/solutions/traders", priority: "0.9", changefreq: "monthly" },
  { path: "/products/os", priority: "0.9", changefreq: "monthly" },
  { path: "/products/corp", priority: "0.9", changefreq: "monthly" },
  { path: "/products/trace", priority: "0.9", changefreq: "monthly" },
  { path: "/products/upstream", priority: "0.9", changefreq: "monthly" },
  { path: "/infrastructure/telco", priority: "0.8", changefreq: "monthly" },
